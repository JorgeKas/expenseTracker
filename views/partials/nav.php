      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="/expenses-mn" class="<?= urlIs('/expenses-mn.php') ? 'bg-gray-900 text-white' : 'text-gray-300'; ?> px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white rounded-md">Expenses</a>
